...
import com.adrianbcodes.timemanager.security.jwt.JwtUtils;
import com.adrianbcodes.timemanager.security.payload.request.LoginRequest;
import com.adrianbcodes.timemanager.security.payload.request.SignupRequest;
import com.adrianbcodes.timemanager.security.payload.response.JwtResponse;
import com.adrianbcodes.timemanager.security.payload.response.MessageResponse;
            ...
            strRoles.forEach(role -> {
                switch (role) {
                    case "admin":
                        ...
                        break;
                    case "mod":
                        Role modRole = roleRepository.getByName(ERole.ROLE_MANAGER)
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
                        roles.add(modRole);
