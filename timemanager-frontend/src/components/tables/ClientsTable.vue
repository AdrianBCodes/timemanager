<template>
    <div class="table">
        ...
        <Dialog v-model:visible="clientDialog" :style="{width: '450px'}" header="Client Details" :modal="true"
            class="p-fluid">
            <div class="field">
...
export default defineComponent({
    setup() {
        ...
        return {
            clients, error, currentPage, size, totalRecords, submitted, client, isEditing, clientDialog,
